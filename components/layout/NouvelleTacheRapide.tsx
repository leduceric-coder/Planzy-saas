...
export function NouvelleTacheRapide({ projects, artisans, teams, orgId, onClose }: Props) {
    ...
    return (
      <SlidePanel onClose={onClose} title="Nouvelle tâche">
        <div className="flex flex-col items-center justify-center gap-3 py-12 text-center">
          ...
          <p className="text-xs text-muted-foreground">Créez d'abord un chantier pour y ajouter des tâches.</p>
        </div>
      </SlidePanel>
    )
  }
